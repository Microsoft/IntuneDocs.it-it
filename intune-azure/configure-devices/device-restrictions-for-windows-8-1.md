...
# <a name="windows-81-and-later-device-restriction-settings-in-intune-azure-preview"></a>Impostazioni relative alle restrizioni dei dispositivi Windows 8.1 e versioni successive nell'anteprima di Intune Azure
