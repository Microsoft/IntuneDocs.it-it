...
# <a name="windows-phone-81-device-restriction-settings-in-intune-azure-preview"></a>Impostazioni relative alle restrizioni dei dispositivi Windows Phone 8.1 nell'anteprima di Intune Azure
