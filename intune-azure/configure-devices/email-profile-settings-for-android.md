...
# <a name="email-profile-settings-for-android-devices-in-intune-azure-preview"></a>Impostazioni relative al profilo di posta elettronica per dispositivi Android nell'anteprima di Intune Azure
