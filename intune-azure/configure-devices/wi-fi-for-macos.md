---
title: Impostazioni Wi-Fi di Intune per dispositivi macOS | Anteprima di Intune in Azure | Documentazione Microsoft
description: "Anteprima di Intune in Azure: informazioni sulle impostazioni di Intune che è possibile usare per configurare le connessioni Wi-Fi nei dispositivi macOS."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="intune-wi-fi-settings-for-macos-devices-in-intune-azure-preview"></a>Impostazioni Wi-Fi di Intune per dispositivi macOS nell'anteprima di Intune in Azure
