---
title: Creare un profilo Wi-Fi con una chiave precondivisa | Anteprima di Intune in Azure | Documentazione Microsoft
description: 'Anteprima di Intune in Azure: usare un profilo personalizzato di Intune per creare un profilo Wi-Fi con una chiave precondivisa.'
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
---
# <a name="use-an-intune-custom-device-profile-to-create-a-wi-fi-profile-with-a-pre-shared-key-in-intune-azure-preview"></a>Usare un profilo di dispositivo personalizzato di Intune per creare un profilo Wi-Fi con una chiave precondivisa nell'anteprima di Intune in Azure
