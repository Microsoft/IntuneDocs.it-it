...
# <a name="custom-settings-for-macos-devices-in-intune-azure-preview"></a>Impostazioni personalizzate per dispositivi macOS nell'anteprima di Intune in Azure
