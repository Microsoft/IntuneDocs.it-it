---
title: Come aggiungere app Android dello store a Intune | Anteprima di Intune in Azure | Documentazione Microsoft
...
# <a name="how-to-add-android-store-apps-to-intune"></a>Come aggiungere app Android dello store a Intune
