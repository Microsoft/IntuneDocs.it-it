                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Dove si trovano le funzionalità di Intune in Azure?</h3>
                                            <p>Se si ha familiarità con Intune nella console classica, questo articolo consente di trovare le funzionalità in Intune o Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/what-is-intune">tutta la documentazione di Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/what-is-intune">tutta la documentazione introduttiva</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune-classic/plan-design/introduction">tutta la documentazione relativa alla pianificazione della distribuzione</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/device-enrollment">tutta la documentazione relativa alle procedure</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">tutta la documentazione per la risoluzione dei problemi</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Si vuole consultare l'intera documentazione? Vedere <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">tutta la documentazione di Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
