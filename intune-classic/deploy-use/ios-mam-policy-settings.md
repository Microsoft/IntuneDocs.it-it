...
| **Richiedi una versione minima dell'SDK dei criteri di protezione app di Intune** | Scegliere **Sì** per richiedere una versione minima dell'SDK dei criteri di protezione delle app di Intune per l'app da usare. All'utente verrà impedito l'accesso se la versione dell'SDK dei criteri di protezione delle app di Intune dell'app non soddisfa il requisito. <br> <br> Per altre informazioni sull'SDK dei criteri di protezione delle app di Intune, vedere [Panoramica di Intune App SDK](https://docs.microsoft.com/en-us/intune/develop/intune-app-sdk) <br><br> | No |
