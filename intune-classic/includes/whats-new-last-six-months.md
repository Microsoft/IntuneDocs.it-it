...
È possibile visualizzare la nuova barra di stato nella [pagina delle novità dell'interfaccia utente dell'app di Intune](/intune/whats-new-app-ui).
...
È possibile trovare gli screenshot dell'esperienza di accesso precedente, della nuova esperienza di accesso con credenziali e della nuova esperienza di accesso da un altro dispositivo nella pagina delle [novità dell'interfaccia utente dell'app](/intune/whats-new-app-ui).
...
Il [Centro per i partner Microsoft](https://partnercenter.microsoft.com/) e l'[interfaccia di amministrazione partner di Microsoft Office 365](https://portal.office.com/) consentiranno entrambi di accedere agli account dei clienti gestiti. Procedendo come partner, usare uno di questi siti per gestire i clienti.
...
Per altre informazioni su queste modifiche, vedere [Aggiornamenti dell'interfaccia utente per le applicazioni degli utenti finali in Intune](/intune/whats-new-app-ui).
...
* [Preparare le app per iOS per la gestione delle app mobili con lo strumento di wrapping delle app di Intune](/intune/app-wrapper-prepare-ios)
* [Introduzione a Microsoft Intune App SDK](/intune/app-sdk-get-started)
* [Manuale dello sviluppatore di Intune App SDK per iOS](/intune/app-sdk-ios)

Gli articoli seguenti sono stati aggiunti alla raccolta della documentazione:

* [Plug-in Cordova per Intune App SDK](/intune/app-sdk-cordova)
* [Componente Xamarin per Intune App SDK](/intune/app-sdk-xamarin)
