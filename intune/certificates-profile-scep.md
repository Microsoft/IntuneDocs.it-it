...
La procedura per assegnare i profili di certificato SCEP è uguale a quella per la [distribuzione dei profili di dispositivo](device-profile-assign.md) per altri scopi. Tuttavia, tenere presente quanto segue prima di continuare:
