---
title: Come aggiungere app line-of-business per iOS in Microsoft Intune
titlesuffix: 
description: Informazioni su come aggiungere app line-of-business (LOB) per iOS in Microsoft Intune.
keywords: 
author: Erikre
ms.author: erikre
manager: dougeby
...
Usare le informazioni di questo articolo per aggiungere le app line-of-business per iOS in Microsoft Intune.
...
2. Nel riquadro **File del pacchetto dell'app** scegliere il pulsante Sfoglia e selezionare un file di installazione iOS con estensione **ipa**.
