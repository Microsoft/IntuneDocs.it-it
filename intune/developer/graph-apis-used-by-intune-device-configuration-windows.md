---
title: API Graph per configurare dispositivi in Microsoft Intune - Azure | Microsoft Docs
titleSuffix: ''
description: Vedere un elenco di tutte le entità API Graph con l'URI di offset e il provider CSP di Windows corrispondente nei dispositivi Windows 10 e versioni successive usate per la configurazione dei dispositivi in Microsoft Intune. Vedere l'API e il provider CSP corrispondenti per PC condivisi, Endpoint Protection, Microsoft Defender Advanced Threat Protection, Identity Protection, Teams per Windows 10, Chiosco multimediale e Windows Update per le aziende.
keywords: ''
...
Microsoft Intune usa le [entità API Graph](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) (apre un altro sito di documentazione) per configurare i dispositivi (**Intune** > **Configurazione del dispositivo**) che eseguono Windows 10 e versioni successive. L'API Graph usa i provider di servizi di configurazione (CSP) per leggere, impostare, modificare e/o eliminare le impostazioni di configurazione nei dispositivi.

Questo elenco si applica a:

- Windows 10 e versioni successive

Questo articolo elenca le entità Graph e gli URI di offset e i provider CSP di Windows 10 corrispondenti.

Queste informazioni sono utili per diversi scenari, ad esempio per vedere gli elementi usati da Intune, le impostazioni da includere nelle configurazioni di URI OMA personalizzate e così via. 

## <a name="windows-10-csps"></a>CSP di Windows 10

Per altre informazioni sul supporto del provider di servizi di configurazione di Windows 10, vedere le [informazioni di riferimento sui provider di servizi di configurazione](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference).

## <a name="graph-api-properties-to-csp-mapping"></a>Corrispondenza tra le proprietà delle API Graph e i provider CSP

L'elenco seguente include la maggior parte delle entità API Graph usate da Microsoft Intune per la configurazione dei dispositivi Windows 10, oltre al provider CSP di Windows 10 e all'URI di offset corrispondenti.

Per visualizzare le versioni di Windows 10 a cui si applicano le API seguenti, usare le [informazioni di riferimento sui provider di servizi di configurazione](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) di Windows 10 (apre un altro sito di documentazione).

### <a name="editionupgradeconfigurationlicense"></a>EditionUpgradeConfiguration.License 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**URI di offset**: /UpgradeEditionWithLicense

### <a name="editionupgradeconfigurationlicensetype"></a>EditionUpgradeConfiguration.LicenseType 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**URI di offset**: /LicenseKeyType

### <a name="editionupgradeconfigurationproductkey"></a>EditionUpgradeConfiguration.ProductKey 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**URI di offset**: /UpgradeEditionWithProductKey

### <a name="editionupgradeconfigurationwindowssmode"></a>EditionUpgradeConfiguration.WindowsSMode 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**URI di offset**: /SMode/SwitchingPolicy

### <a name="sharedpcconfigurationaccountmanagerpolicy"></a>SharedPCConfiguration.AccountManagerPolicy 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /DeletionPolicy, /DiskLevelCaching, /InactiveThreshold, /DiskLevelDeletion

### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (dispositivi di destinazione per l'edizione Windows Holographic for Business) 
**CSP**: ./Vendor/MSFT/AccountManagement  
**URI di offset**: /DeletionPolicy, /StorageCapacityStartDeletion, /StorageCapacityStopDeletion, /ProfileInactivityThreshold

### <a name="sharedpcconfigurationallowedaccounts"></a>SharedPCConfiguration.AllowedAccounts 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /AccountModel

### <a name="sharedpcconfigurationallowlocalstorage"></a>SharedPCConfiguration.AllowLocalStorage 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /RestrictLocalStorage

### <a name="sharedpcconfigurationdisableaccountmanager"></a>SharedPCConfiguration.DisableAccountManager 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /EnableAccountManager

### <a name="sharedpcconfigurationdisableedupolicies"></a>SharedPCConfiguration.DisableEduPolicies 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /SetEduPolicies

### <a name="sharedpcconfigurationdisablepowerpolicies"></a>SharedPCConfiguration.DisablePowerPolicies 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /SetPowerPolicies

### <a name="sharedpcconfigurationdisablesigninonresume"></a>SharedPCConfiguration.DisableSignInOnResume 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /SignInOnResume

### <a name="sharedpcconfigurationenabled"></a>SharedPCConfiguration.Enabled 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /EnableSharedPCMode

### <a name="sharedpcconfigurationidletimebeforesleepinseconds"></a>SharedPCConfiguration.IdleTimeBeforeSleepInSeconds 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /InactiveThreshold

### <a name="sharedpcconfigurationkioskappdisplayname"></a>SharedPCConfiguration.KioskAppDisplayName 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /KioskModeUserTileDisplayText

### <a name="sharedpcconfigurationkioskappusermodelid"></a>SharedPCConfiguration.KioskAppUserModelId 
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /KioskModeAUMID
...
**CSP**: ./Vendor/MSFT/SharedPC  
**URI di offset**: /MaintenanceStartTime
...
**URI di offset**: /Config/SmartScreen/PreventOverrideForFilesInShell
...
**URI di offset**: /Settings/SaveFilesToHost
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/AllowPersistence
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/PrintingSettings
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/AllowVirtualGPU
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/ClipboardSettings
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/ClipboardFileType
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/BlockNonEnterpriseContent
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Settings/AllowWindowsDefenderApplicationGuard
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI di offset**: /Audit/AuditApplicationGuard
...
**URI di offset**: /AllowStandardUserEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /AllowWarningForOtherDiskEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /RequireStorageCardEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /RequireDeviceEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /EncryptionMethodByDriveType, /FixedDrivesRequireEncryption, /FixedDrivesRecoveryOptions
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /EncryptionMethodByDriveType, /RemovableDrivesRequireEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**URI di offset**: /EncryptionMethodByDriveType, /SystemDrivesRequireStartupAuthentication, /SystemDrivesMinimumPINLength, /SystemDrivesRecoveryMessage, /SystemDrivesRecoveryOptions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteDesktopServices/ClientConnectionEncryptionLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/ConfigureSMBV1ClientDriver
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/DisableDownloadingOfPrintDriversOverHTTP
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/HardenedUNCPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/DisableInternetDownloadForWebPublishingAndOnlineOrderingWizards
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/DiablePrintingOverHTTP
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/CredentialsUI/EnumerateAdministrators
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/Defender/ControlledFolderAccessProtectedFolders
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AttackSurfaceReductionRules
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AttackSurfaceReductionOnlyExclusions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowEmailScanning
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/Defender/ControlledFolderAccessAllowedApplications
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/EnableControlledFolderAccess
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/Defender/EnableNetworkProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/TurnOnWindowsDefenderProtectionAgainstPotentiallyUnwantedApplications
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/WindowsDefenderSecurityCenter/DisallowExploitProtectionOverride
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableAccountProtectionUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableAppBrowserUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableFamilyUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableHealthUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableNetworkUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/HideSecureBoot
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/HideTPMTroubleshooting
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/DisableVirusUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/Email
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/Phone
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/URL
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /WindowsDefenderSecurityCenter/EnableCustomizedToasts, /WindowsDefenderSecurityCenter/EnableInAppCustomization
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/HideWindowsSecurityNotificationAreaControl
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsDefenderSecurityCenter/CompanyName
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/DeviceGuard/EnableVirtualizationBasedSecurity
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceGuard/ConfigureSystemGuardLaunch
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceGuard/LsaCfgFlags
...
**URI di offset**: /Config/DmaGuard/DeviceEnumerationPolicy
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/EventLogService/SpecifyMaximumFileSizeApplicationLog
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/EventLogService/SpecifyMaximumFileSizeSecurityLog
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/EventLogService/SpecifyMaximumFileSizeSystemLog
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/FileExplorer/TurnOffDataExecutionPreventionForExplorer
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/FileExplorer/TurnOffHeapTerminationOnCorruption
...
**URI di offset**: /MdmStore/Global/DisableStatefulFtp
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/CRLcheck
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/SaIdleTime
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/IPsecExempt
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/OpportunisticallyMatchAuthSetPerKM
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/EnablePacketQueue
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/Global/PresharedKeyEncoding
...
**URI di offset**: /MdmStore/DomainProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/DomainProfile/DisableInboundNotifications

### <a name="windows10endpointprotectionconfigurationfirewallprofiledomaininboundnotificationsblocked"></a>windows10endpointprotectionconfiguration.firewallProfileDomain.inboundNotificationsBlocked 
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/DomainProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/DomainProfile/DefaultOutboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PrivateProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PrivateProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PrivateProfile/DisableInboundNotifications
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PrivateProfile/DefaultOutboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/AllowLocalIpsecPolicyMerge
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/DisableInboundNotifications
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/DefaultOutboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**URI di offset**: /MdmStore/PublicProfile/AllowLocalPolicyMerge
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_LANManagerAuthenticationLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/LanmanWorkstation/EnableInsecureGuestLogons
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameAdministratorAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForAdministrators
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_DoNotAllowAnonymousEnumerationOfSamAccountsAndShares
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_AllowPKU2UAuthenticationRequests
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Shutdown\_AllowSystemToBeShutDownWithoutHavingToLogOn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_AllowUIAccessApplicationsToPromptForElevation
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateUIAccessApplicationsThatAreInstalledInSecureLocations
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowUndockWithoutHavingToLogon
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_BlockMicrosoftAccounts
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_LimitLocalAccountUseOfBlankPasswordsToConsoleLogonOnly
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Devices\_RestrictCDROMAccessToLocallyLoggedOnUserOnly
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Devices\_PreventUsersFromInstallingPrinterDriversWhenConnectingToSharedPrinters
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Shutdown\_ClearVirtualMemoryPageFile
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_SendUnencryptedPasswordToThirdPartySMBServers
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_DetectApplicationInstallationsAndPromptForElevation
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableAdministratorAccountStatus
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsIfServerAgrees
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableGuestAccountStatus
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsIfClientAgrees
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_DoNotAllowAnonymousEnumerationOfSAMAccounts
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotRequireCTRLALTDEL
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_DoNotStoreLANManagerHashValueOnNextPasswordChange
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowedToFormatAndEjectRemovableMedia
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameGuestAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayLastSignedIn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayUsernameAtSignIn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DisplayUserInformationWhenTheSessionIsLocked
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTextForUsersAttemptingToLogOn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTitleForUsersAttemptingToLogOn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MachineInactivityLimit
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedClients
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedServers
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateExecutableFilesThatAreSignedAndValidated
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictAnonymousAccessToNamedPipesAndShares
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_SmartCardRemovalBehavior
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForStandardUsers
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_SwitchToTheSecureDesktopWhenPromptingForElevation
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_UseAdminApprovalMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_RunAllAdministratorsInAdminApprovalMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_VirtualizeFileAndRegistryWriteFailuresToPerUserLocations
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSLegacy/AllowICMPRedirectsToOverrideOSPFGeneratedRoutes
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSLegacy/AllowTheComputerToIgnoreNetBIOSNameReleaseRequestsExceptFromWINSServers
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSLegacy/IPSourceRoutingProtectionLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSLegacy/IPv6SourceRoutingProtectionLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/CredentialProviders/AllowPINLogon
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsPowerShell/TurnOnPowerShellScriptBlockLogging
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteDesktopServices/DoNotAllowDriveRedirection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteDesktopServices/DoNotAllowPasswordSaving
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteDesktopServices/PromptForPasswordUponConnection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteDesktopServices/RequireSecureRPCCommunication
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/CredentialsDelegation/RemoteHostAllowsDelegationOfNonExportableCredentials
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/AllowBasicAuthentication\_Client
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/DisallowDigestAuthentication
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/AllowUnencryptedTraffic\_Client
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/AllowBasicAuthentication\_Service
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/DisallowStoringOfRunAsCredentials
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteManagement/AllowUnencryptedTraffic\_Service
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteProcedureCall/RestrictUnauthenticatedRPCClients
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/ApplyUACRestrictionsToLocalAccountsOnNetworkLogon
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/ConfigureSMBV1Server
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/EnableStructuredExceptionHandlingOverwriteProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/MSSecurityGuide/WDigestAuthentication
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/SmartScreen/EnableSmartScreenInShell
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/RemoteAssistance/SolicitedRemoteAssistance
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/AccessCredentialManagerAsTrustedCaller
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/AccessFromNetwork
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ActAsPartOfTheOperatingSystem
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/BackupFilesAndDirectories
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/DenyAccessFromNetwork
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ChangeSystemTime
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/CreateGlobalObjects
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/CreatePageFile
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/CreatePermanentSharedObjects
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/CreateSymbolicLinks
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/CreateToken
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/DebugPrograms
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/EnableDelegation
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/GenerateSecurityAudits
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ImpersonateClient
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/IncreaseSchedulingPriority
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/LoadUnloadDeviceDrivers
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/AllowLocalLogOn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/LockMemory
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ManageAuditingAndSecurityLog
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ManageVolume
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ModifyFirmwareEnvironment
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ModifyObjectLabel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/ProfileSingleProcess
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/DenyLocalLogOn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/DenyRemoteDesktopServicesLogOn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/RemoteShutdown
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/RestoreFilesAndDirectories
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/UserRights/TakeOwnership
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsConnectionManager/ProhitConnectionToNonDomainNetworksWhenConnectedToDomainAuthenticatedNetwork
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsLogon/SignInLastInteractiveUserAutomaticallyAfterASystemInitiatedRestart
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/SystemServices/ConfigureXboxAccessoryManagementServiceStartupMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/TaskScheduler/EnableXboxGameSaveTask
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/SystemServices/ConfigureXboxLiveAuthManagerServiceStartupMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/SystemServices/XboxServicesLiveGameSaveServiceStartupMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/SystemServices/ConfigureXboxLiveNetworkingServiceStartupMode
...
**CSP**: N/D Solo chiamata API Graph **URI di offset**: N/D Solo chiamata API Graph
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Accounts/AllowAddingNonMicrosoftAccountsManually

### <a name="windows10generalconfigurationantitheftmodeblocked"></a>Windows10GeneralConfiguration.AntiTheftModeBlocked 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/AntiTheftMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/MSIAllowUserControlOverInstall
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/MSIAlwaysInstallWithElevatedPrivileges
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowAllTrustedApps
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/DisableStoreOriginatedApps
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/AppRuntime/AllowMicrosoftAccountsToBeOptional
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Authentication/AllowFidoDeviceSignon
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Authentication/AllowSecondaryAuthenticationDevice
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Authentication/PreferredAadTenantDomainName

### <a name="windows10generalconfigurationauthenticationwebsignin"></a>Windows10GeneralConfiguration.AuthenticationWebSignIn 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Authentication/EnableWebSignIn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Autoplay/SetDefaultAutoRunBehavior
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Bluetooth/AllowPromptedProximalConnections

### <a name="windows10generalconfigurationbluetoothdevicename"></a>Windows10GeneralConfiguration.BluetoothDeviceName 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Bluetooth/LocalDeviceName
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/System/BootStartDriverInitialization

### <a name="windows10generalconfigurationcamerablocked"></a>Windows10GeneralConfiguration.CameraBlocked 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Camera/AllowCamera
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/AllowCellularDataRoaming

### <a name="windows10generalconfigurationcellularblockvpn"></a>Windows10GeneralConfiguration.CellularBlockVpn 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/AllowVPNOverCellular
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/AllowVPNRoamingOverCellular

### <a name="windows10generalconfigurationcellulardata"></a>Windows10GeneralConfiguration.CellularData 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Connectivity/AllowCellularData
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/AllowManualRootCertificateInstallation
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Cryptography/AllowFipsAlgorithmPolicy
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DataProtection/AllowDirectMemoryAccess
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowUserUIAccess
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/CloudExtendedTimeout
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/DaysToRetainCleanedMalware
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/ThreatSeverityDefaultAction
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/ExcludedExtensions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/ExcludedPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowRealtimeMonitoring
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/PUAProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/ExcludedProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/SubmitSamplesConsent
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowBehaviorMonitoring
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowCloudProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowIntrusionPreventionSystem
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowFullScanOnMappedNetworkDrives

### <a name="windows10generalconfigurationdefenderscanmaxcpu"></a>Windows10GeneralConfiguration.DefenderScanMaxCpu 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AvgCPULoadFactor
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/AllowFullScanRemovableDriveScanning
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Defender/SignatureUpdateInterval
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowDeveloperUnlock
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/System/AllowUserToResetPhone
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowManualMDMUnenrollment
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/System/AllowTelemetry
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Display/TurnOffGdiDPIScalingForApps
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Display/TurnOnGdiDPIScalingForApps
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/HomePages
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/PreventAccessToAboutFlagsInMicrosoftEdge
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/AllowInPrivate
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/AllowSearchSuggestionsinAddressBar
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/AllowDoNotTrack
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/SendIntranetTraffictoInternetExplorer
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/AllowWebContentOnNewTabPage
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/EnterpriseSiteListServiceUrl
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/SetHomeButtonURL
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/ConfigureHomeButton
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/SetNewTabPageURL

### <a name="windows10generalconfigurationedgeopenswith"></a>Windows10GeneralConfiguration.EdgeOpensWith 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/ConfigureOpenMicrosoftEdgeWith
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/ShowMessageWhenOpeningSitesInInternetExplorer
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/SyncFavoritesBetweenIEAndMicrosoftEdge
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/ConfigureTelemetryForMicrosoft365Analytics
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/CredentialProviders/DisableAutomaticReDeploymentCredentials
...
**URI di offset**: /Config/EnterpriseCloudPrint/CloudPrinterDiscoveryEndPoint
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/EnterpriseCloudPrint/DiscoveryMaxPrinterLimit
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/EnterpriseCloudPrint/MopriaDiscoveryResourceId
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/EnterpriseCloudPrint/CloudPrintOAuthAuthority
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/EnterpriseCloudPrint/CloudPrintResourceId
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowWindowsConsumerFeatures
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowDeviceDiscovery
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowSIMErrorDialogPromptWhenNoSIM
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowTaskSwitcher
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowWindowsSpotlight
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/DoNotSyncBrowserSettings

### <a name="windows10generalconfigurationgamedvrblocked"></a>Windows10GeneralConfiguration.GameDvrBlocked 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowGameDVR
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceInstallation/PreventInstallationOfMatchingDeviceIDs
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceInstallation/PreventInstallationOfMatchingDeviceSetupClasses

### <a name="windows10generalconfigurationinkworkspaceaccess"></a>Windows10GeneralConfiguration.InkWorkspaceAccess 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsInkWorkspace/AllowWindowsInkWorkspace
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsInkWorkspace/AllowSuggestedAppsInWindowsInkWorkspace
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DoNotAllowActiveXControlsInProtectedMode
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/AllowAutoComplete
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DoNotBlockOutdatedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableBypassOfSmartScreenWarnings
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableBypassOfSmartScreenWarningsAboutUncommonFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/AllowCertificateAddressMismatchWarning
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/CheckServerCertificateRevocation
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/CheckSignaturesOnDownloadedPrograms
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableCrashDetection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableProcessesInEnhancedProtectedMode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableEnclosureDownloading
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableEncryptionSupport
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/AllowEnhancedProtectedMode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/AllowFallbackToSSL3
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableIgnoringCertificateErrors
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/IncludeAllNetworkPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowAccessToDataSources
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowOnlyApprovedDomainsToUseActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowOnlyApprovedDomainsToUseTDCActiveXControl
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowVBScriptToRunInInternetExplorer
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowAutomaticPromptingForFileDownloads
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowCopyPasteViaScript
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneEnableCrossSiteScriptingFilter
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowNETFrameworkReliantComponents
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneDownloadSignedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneDownloadUnsignedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowDragAndDropCopyAndPasteFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneEnableDraggingOfContentFromDifferentDomainsAcrossWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneEnableDraggingOfContentFromDifferentDomainsWithinWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneIncludeLocalPathWhenUploadingFilesToServer
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneInitializeAndScriptActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneLaunchingApplicationsAndFilesInIFRAME
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowLessPrivilegedSites
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowLoadingOfXAMLFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneLogonOptions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneNavigateWindowsAndFrames
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneUsePopupBlocker
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneEnableProtectedMode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneRunNETFrameworkReliantComponentsSignedWithAuthenticode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowScriptingOfInternetExplorerWebBrowserControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowScriptInitiatedWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowScriptlets
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneShowSecurityWarningForPotentiallyUnsafeFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowSmartScreenIE
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowUpdatesToStatusBarViaScript
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/InternetZoneAllowUserDataPersistence
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/IntranetZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/IntranetZoneInitializeAndScriptActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/IntranetZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LocalMachineZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LocalMachineZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownInternetZoneAllowSmartScreenIE
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownIntranetJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownLocalMachineZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownRestrictedSitesZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownRestrictedSitesZoneAllowSmartScreenIE
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/LockedDownTrustedSitesZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/PreventManagingSmartScreenFilter
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/PreventPerUserInstallationOfActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/ConsistentMimeHandlingInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/MimeSniffingSafetyFeatureInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/MKProtocolSecurityRestrictionInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/NotificationBarInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/ProtectionFromZoneElevationInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictActiveXInstallInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictFileDownloadInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/ScriptedWindowSecurityRestrictionsInternetExplorerProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RemoveRunThisTimeButtonForOutdatedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowAccessToDataSources
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowActiveScripting
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseTDCActiveXControl
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowVBScriptToRunInInternetExplorer
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowAutomaticPromptingForFileDownloads
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowBinaryAndScriptBehaviors
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowCopyPasteViaScript
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneEnableCrossSiteScriptingFilter
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowNETFrameworkReliantComponents
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneDownloadSignedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneDownloadUnsignedActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowDragAndDropCopyAndPasteFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneEnableDraggingOfContentFromDifferentDomainsAcrossWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneEnableDraggingOfContentFromDifferentDomainsWithinWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowFileDownloads
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneIncludeLocalPathWhenUploadingFilesToServer
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneInitializeAndScriptActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneLaunchingApplicationsAndFilesInIFRAME
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowLessPrivilegedSites
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowLoadingOfXAMLFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneLogonOptions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowMETAREFRESH
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneNavigateWindowsAndFrames
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneUsePopupBlocker
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneTurnOnProtectedMode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneRunActiveXControlsAndPlugins
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneRunNETFrameworkReliantComponentsSignedWithAuthenticode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneScriptActiveXControlsMarkedSafeForScripting
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneScriptingOfJavaApplets
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowScriptingOfInternetExplorerWebBrowserControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowScriptInitiatedWindows
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowScriptlets
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneShowSecurityWarningForPotentiallyUnsafeFiles
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowSmartScreenIE
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowUpdatesToStatusBarViaScript
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/RestrictedSitesZoneAllowUserDataPersistence
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DisableSecuritySettingsCheck
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/SecurityZonesUseOnlyMachineSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/AllowSoftwareWhenSignatureIsInvalid
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/TrustedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/TrustedSitesZoneInitializeAndScriptActiveXControls
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/TrustedSitesZoneJavaPermissions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/SpecifyUseOfActiveXInstallerService
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/InternetExplorer/DoNotAllowUsersToAddSites
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/AllowScreenTimeoutWhileLockedUser/Config
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/AboveLock/AllowActionCenterNotifications
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/AboveLock/AllowToasts

### <a name="windows10generalconfigurationlockscreencamera"></a>Windows10GeneralConfiguration.LockScreenCamera 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/PreventEnablingLockScreenCamera
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsLogon/DontDisplayNetworkSelectionUI

### <a name="windows10generalconfigurationlockscreenslideshow"></a>Windows10GeneralConfiguration.LockScreenSlideShow 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/PreventLockScreenSlideShow
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/ScreenTimeoutWhileLocked
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowSyncMySettings
...
**URI di offset**: /AllowMicrosoftAccountSignInAssistant
...
**URI di offset**: /ProxySettingsPerUser
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/MinDevicePasswordComplexCharacters

### <a name="windows10generalconfigurationpasswordminimumlength"></a>Windows10GeneralConfiguration.PasswordMinimumLength 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/MinDevicePasswordLength
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/MaxInactivityTimeDeviceLock
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/AllowIdleReturnWithoutPassword
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeviceLock/MaxDevicePasswordFailedAttempts
...
**CSP**: ./Device/Vendor/MSFT/Personalization  
**URI di offset**: /LockScreenImageUrl
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Power/RequirePasswordWhenComputerWakesOnBattery
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Power/RequirePasswordWhenComputerWakesPluggedIn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Power/AllowStandbyStatesWhenSleepingOnBattery
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Power/AllowStandbyWhenSleepingPluggedIn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Privacy/AllowAutoAcceptPairingAndPrivacyConsentPrompts

### <a name="windows10generalconfigurationprivacyblockactivityfeed"></a>Windows10GeneralConfiguration.PrivacyBlockActivityFeed 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Privacy/EnableActivityFeed
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Privacy/AllowInputPersonalization
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Search/AlwaysUseAutoLangDetection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Search/DisableBackoff
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Search/AllowIndexingEncryptedStoresOrItems
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/PreventAutomaticDeviceEncryptionForAzureADJoinedDevices

### <a name="windows10generalconfigurationsettingsblockaccountspage"></a>Windows10GeneralConfiguration.SettingsBlockAccountsPage 
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Settings/PageVisibilityList
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/AllowAddProvisioningPackage
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Settings/AllowLanguage
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Settings/AllowDateTime
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Settings/AllowEditDeviceName
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/AllowRemoveProvisioningPackage
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowSharedUserAppData
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/PreventSmartScreenPromptOverride
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/PreventSmartScreenPromptOverrideForFiles
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/SmartScreen/EnableAppInstallControl
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/NoPinningToTaskbar
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/HideAppList
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/HideChangeAccountSettings
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/HideRecentJumplists
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/HideRecentlyAddedApps
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderDocuments
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderDownloads
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderFileExplorer
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderHomeGroup
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderMusic
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderNetwork
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderPersonalFolder
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderPictures
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderSettings
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Start/AllowPinnedFolderVideos
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/System/AllowStorageCard
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Security/RequireDeviceEncryption
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/RestrictAppDataToSystemVolume
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/RestrictAppToSystemVolume
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/PreventUsingLocalHostIPAddressForWebRTC
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/WiFi/AllowAutoConnectToWiFiSenseHotspots

### <a name="windows10generalconfigurationwifiblocked"></a>Windows10GeneralConfiguration.WiFiBlocked 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Wifi/AllowWiFi
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/WindowsLogon/EnumerateLocalUsersOnDomainJoinedComputers
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowWindowsSpotlightOnActionCenter
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowTailoredExperiencesWithDiagnosticData
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowThirdPartySuggestionsInWindowsSpotlight
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowWindowsSpotlightWindowsWelcomeExperience
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/AllowWindowsTips
...
**CSP**: ./User/Vendor/MSFT/Policy  
**URI di offset**: /Config/Experience/ConfigureWindowsSpotlightOnLockScreen
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowAppStoreAutoUpdate

### <a name="windows10generalconfigurationwindowsstoreblocked"></a>Windows10GeneralConfiguration.WindowsStoreBlocked 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/AllowStore
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/ApplicationManagement/RequirePrivateStoreOnly
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/WirelessDisplay/AllowProjectionToPC
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/WirelessDisplay/AllowUserInputFromWirelessDisplayReceiver
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/WirelessDisplay/RequirePINForPairing
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/NetworkIsolation/EnterpriseCloudResources, /Config/NetworkIsolation/EnterpriseIPRange, /Config/NetworkIsolation/EnterpriseIPRangesAreAuthoritative, /Config/NetworkIsolation/EnterpriseInternalProxyServers, /Config/NetworkIsolation/EnterpriseNetworkDomainNames, /Config/NetworkIsolation/EnterpriseProxyServers, /Config/NetworkIsolation/EnterpriseProxyServersAreAuthoritative, /Config/NetworkIsolation/NeutralResources
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/ControlPolicyConflict/MDMWinsOverGP
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**URI di offset**: /AllowScreenMonitoring
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**URI di offset**: /AllowTextSuggestions
...
**URI di offset**: /MOMAgent/WorkspaceID and /MOMAgent/WorkspaceKey
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /MOMAgent/WorkspaceID
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /MOMAgent/WorkspaceKey
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /InBoxApps/Connect/AutoLaunch
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /DeviceAccount/Email
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /DeviceAccount/ExchangeServer
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /DeviceAccount/PasswordRotationEnabled
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /DeviceAccount/SipAddress
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /MaintenanceHoursSimple/Hours/Duration and /MaintenanceHoursSimple/Hours/StartTime
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /MaintenanceHoursSimple/Hours/Duration
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /Properties/DoNotShowMyMeetingsAndFiles
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /Properties/AllowSessionResume
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /Properties/ScreenTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /Properties/SleepTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /InBoxApps/Welcome/CurrentBackgroundPath
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /InBoxApps/Welcome/AutoWakeScreen
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI di offset**: /InBoxApps/Welcome/MeetingInfoOption
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**URI di offset**: /Configuration/SampleSharing
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**URI di offset**: /Configuration/TelemetryReportingFrequency
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/DeliveryOptimization/DODownloadMode
...
**URI di offset**: /Biometrics/FacialFeaturesUseEnhancedAntiSpoofing
...
**URI di offset**: /{AADTenantId}/Policies/PINComplexity/Expiration
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/PINComplexity/History
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/EnablePinRecovery
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/PINComplexity/SpecialCharacters
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/PINComplexity/UppercaseLetters
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/RequireSecurityDevice
...
**CSP**: ./Device/Vendor/MSFT/PassportForWork  
**URI di offset**: /Biometrics/UseBiometrics
...
**CSP**: ./Device/Vendor/MSFT/PassportForWork  
**URI di offset**: /{AADTenantId}/Policies/UseCertificateForOnPremAuth
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Browser/ConfigureKioskResetAfterIdleTimeout
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/KioskBrowser/EnableNavigationButtons
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/KioskBrowser/KioskBrowserRestartOnIdleTimeInMinutes
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/AllowAutoUpdate
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/AutoRestartRequiredNotificationDismissal
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/BranchReadinessLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/ExcludeWUDriversInQualityUpdate
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartDeadlineForFeatureUpdates
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartDeadline
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartSnoozeScheduleForFeatureUpdates
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartSnoozeSchedule
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartTransitionScheduleForFeatureUpdates
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/EngagedRestartTransitionSchedule
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/DeferFeatureUpdatesPeriodInDays
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/PauseFeatureUpdates
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/PauseFeatureUpdatesStartTime
...
**CSP**: N/D - Solo API Graph **URI di offset**: N/D - Solo API Graph
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI di offset**: /Config/Update/ActiveHoursStart, /Config/Update/ActiveHoursEnd, /Config/Update/ScheduledInstallDay, /Config/Update/ScheduledInstallTime
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/AllowMUUpdateService
...
**CSP**: ./Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/ManagePreviewBuilds
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/DeferQualityUpdatesPeriodInDays
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/PauseQualityUpdates
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/PauseQualityUpdatesStartTime
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/ScheduleImminentRestartWarning
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/ScheduleRestartWarning
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/SetEDURestart

### <a name="windowsupdateforbusinessconfigurationupdateweeks"></a>WindowsUpdateForBusinessConfiguration.UpdateWeeks 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/ScheduledInstallEveryWeek, /Config/Update/ScheduledInstallFirstWeek, /Config/Update/ScheduledInstallFourthWeek, /Config/Update/ScheduledInstallSecondWeek, /Config/Update/ScheduledInstallThirdWeek

### <a name="windowsupdateforbusinessconfigurationuserpauseaccess"></a>WindowsUpdateForBusinessConfiguration.UserPauseAccess 
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI di offset**: /Config/Update/SetDisablePauseUXAccess


## <a name="next-steps"></a>Passaggi successivi

- [Panoramica della configurazione del dispositivo](../configuration/device-profiles.md)
- [Informazioni di riferimento sui provider di servizi di configurazione](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (apre un altro sito di documentazione)
