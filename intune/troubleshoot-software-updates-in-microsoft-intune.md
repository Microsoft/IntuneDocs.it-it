...
Agevolare la risoluzione dei problemi degli aggiornamenti software in Microsoft Intune.
...
La tabella seguente elenca i codici di errore dell'**agente di aggiornamento** di Intune. Se non è possibile trovare un codice di errore specifico in questa tabella, vedere [Elenco dei codici di errore di Windows Update](https://support.microsoft.com/help/938205/windows-update-error-code-list).
...
**Risoluzione**:  
1. Accedere al [portale di Azure](https://portal.azure.com) e aprire **Microsoft Intune**. 
2. Selezionare **Aggiornamenti software**.
3. Rifiutare tutti gli aggiornamenti sostituiti applicabili a Windows 7 o alle applicazioni (ad esempio, Microsoft Office) che sono state installate nei client interessati.
