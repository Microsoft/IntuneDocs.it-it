...
- **Timeout di sospensione (in secondi)**: immettere il numero di secondi di inattività (0-100) prima che il dispositivo passa alla modalità sospensione. Se non si imposta alcun valore, il dispositivo passa in modalità sospensione dopo 60 minuti.
...
- **Ora (in minuti rispetto alla mezzanotte) di inizio manutenzione**: immettere il tempo in minuti (0-1440) quando esegue attività di manutenzione automatica, ad esempio Windows Update. L'ora di avvio predefinito è mezzanotte, ovvero zero (`0`) minuti. Per cambiare l'ora di inizio, immettere un'ora in minuti successivi alla mezzanotte. Se ad esempio si vuole che la manutenzione inizi alle 2.00, immettere `120`. Se si vuole che la manutenzione inizi alle 20.00, immettere `1200`.
