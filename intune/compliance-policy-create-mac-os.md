...
---
# <a name="create-a-device-compliance-policy-for-macos-devices-preview-with-intune"></a>Creare criteri di conformità per i dispositivi macOS (anteprima) con Intune
