...
description: "Informazioni su come usare lo strumento Apple Configurator per registrare i dispositivi iOS di proprietà dell'azienda con Assistente configurazione (nuova interfaccia utente).\""
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>In caso contrario, se la pagina **Registrazione del dispositivo** è simile all'immagine seguente, l'account non è ancora stato aggiornato alla nuova interfaccia utente. Passare a [questa pagina della Guida](apple-configurator-enroll-ios.md).
>
