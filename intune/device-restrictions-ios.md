...
-   **Password**: richiede all'utente finale di immettere una password per accedere al dispositivo.
    ...
    -   **Numero di errori di accesso prima della cancellazione dei dati del dispositivo** - Specifica il numero di tentativi univoci di immissione di una password non valida prima che questa impostazione cancelli il dispositivo.
...
-   **Notifiche di Portafoglio durante il blocco del dispositivo** - Consente all'utente di accedere all'app Portafoglio mentre il dispositivo è bloccato.
