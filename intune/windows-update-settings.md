...
- **Documentazione di riferimento di Windows**: [aggiornamento/BranchReadinessLevel](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-branchreadinesslevel)  
...
- **Default**: Consenti
- **Documentazione di riferimento di Windows**: [aggiornamento/AllowMUUpdateService](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-allowmuupdateservice)
...
- **Default**: Consenti
- **Documentazione di riferimento di Windows**: [aggiornamento/ExcludeWUDriversInQualityUpdate](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-excludewudriversinqualityupdate)
...
- **Documentazione di riferimento di Windows**: [aggiornamento/DeferQualityUpdatesPeriodInDays](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-deferqualityupdatesperiodindays)  
...
- **Impostazione predefinita**: 0  
- **Documentazione di riferimento di Windows**: [aggiornamento/PauseFeatureUpdatesPeriodInDays](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-deferfeatureupdatesperiodindays)  
...
- *Windows versione 1709 o successiva*: da 0 a 365 giorni  
- *Windows versione 1703*: 0 e 180 giorni  
...
- **Documentazione di riferimento di Windows**: [aggiornamento/ConfigureFeatureUpdateUninstallPeriod](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-configurefeatureupdateuninstallperiod)  
...
- **Installa automaticamente durante la manutenzione**: aggiorna automaticamente il download ed esegue l'installazione durante la Manutenzione automatica quando il dispositivo non è in uso oppure è alimentato a batteria. Quando il riavvio è obbligatorio, viene richiesto il riavvio per sette giorni, dopo di ché il riavvio viene forzato.  
  ...
  - **Inizio dell'orario di attività**: consente di specificare un'ora di inizio per impedire i riavvi conseguenti all'installazione degli aggiornamenti.  
    **Documentazione di riferimento di Windows**: [aggiornamento/ActiveHoursStart](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-activehoursstart)  
    **Default**: 8 AM  
  ...
  - **Fine dell'orario di attività**: consente di specificare un'ora di fine per impedire i riavvi conseguenti all'installazione degli aggiornamenti.  
    **Documentazione di riferimento di Windows**: [aggiornamento/ActiveHoursEnd](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-activehoursend)  
    **Default**: 5 del Pomeriggio  
...
- **Installa e riavvia automaticamente all'ora pianificata**: consente di specificare un giorno e un'ora per l'installazione. Se non vengono specificati, l'installazione viene eseguita ogni giorno alle 15:00 e dopo un conto alla rovescia di 15 minuti, il dispositivo viene riavviato. Gli utenti che hanno eseguito l'accesso possono ritardare il conto alla rovescia e riavviare.  
  ...
  **Documentazione di riferimento di Windows**: [Update/AllowAutoUpdate](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)  
  ...
  - **Giorno pianificato per l'installazione**: specificare il giorno della settimana si desidera che gli aggiornamenti da installare.  
    **Default**: dei giorni  

  - **Ora di installazione pianificata**: specificare l'ora del giorno in cui gli aggiornamenti da installare.  
    **Default**: 3 AM  
...
- **Default**: Consenti  
- **Documentazione di riferimento di Windows**: [aggiornamento/SetEDURestart](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-setedurestart)  
...
- **Default**: Consenti  
- **Documentazione di riferimento di Windows**: [aggiornamento/SetDisablePauseUXAccess](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-setdisablepauseuxaccess)  
...
- **Documentazione di riferimento di Windows**: [aggiornamento/AutoRestartRequiredNotificationDismissal](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-autorestartrequirednotificationdismissal)
...
- **Impostazione predefinita**: *non configurato per impostazione predefinita. Non vengono inviati promemoria agli utenti.*  
- **Documentazione di riferimento di Windows**: [aggiornamento/ScheduleRestartWarning](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-schedulerestartwarning)  
...
- **Impostazione predefinita**: *non configurato per impostazione predefinita. Non vengono inviati promemoria agli utenti.*  
- **Documentazione di riferimento di Windows**: [aggiornamento/ScheduleImminentRestartWarning](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-scheduleimminentrestartwarning) 
...
- **Versione di Windows**: supportate per Windows 10 versione 1803 e versioni successive  
...
- **Esegui la transizione degli utenti al riavvio in caso di occupato dopo un riavvio automatico (giorni)**  
  ...
  - **Documentazione di riferimento di Windows**: [aggiornamento/EngagedRestartTransitionSchedule](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestarttransitionschedule)  
...
- **Posponi il promemoria per il riavvio in caso di occupato (giorni)**  
  ...
  - **Documentazione di riferimento di Windows**: [aggiornamento/EngagedRestartSnoozeSchedule](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestartsnoozeschedule)  
...
- **Imposta la scadenza per i riavvii in sospeso (giorni)**  
  - **Impostazione predefinita**: per impostazione predefinita, questa impostazione non è configurata, ma supporta un valore compreso tra **2** e **30**.  
  - **Documentazione di riferimento di Windows**: [aggiornamento/EngagedRestartDeadline](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestartdeadline)  
