...
|Codice di errore|Nome simbolico|Ulteriori informazioni|
|--------------|-----------------|--------------------|
...
|**0x80cf0FFF**|OM_E_UNEXPECTED|Un'operazione non è riuscita a causa di motivi non spiegati da un altro codice di errore.|
...
|**0x80cf4024**|OM_E_PT_HTTP_STATUS_VERSION_NOT_SUP|Uguale allo **stato HTTP 505**. Il server non supporta la versione del protocollo HTTP utilizzata per la richiesta.|
...
|**0x80cfFFFF**|OM_E_REPORTER_UNEXPECTED|Si è verificato un errore nel report non coperto da un altro codice di errore.|
