...
Per abilitare la connessione Mobile Threat Defense (MTD) in Intune, è necessario avere già configurato il connettore Intune nella console di della soluzione MTD.
...
[Creare criteri di conformità dei dispositivi Mobile Threat Defense con Intune](mtd-device-compliance-policy-create.md)
