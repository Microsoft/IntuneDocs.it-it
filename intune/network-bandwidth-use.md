...
-   Intune richiede accesso del server proxy non autenticato a manage.microsoft.com per determinate operazioni, ad esempio il download di software e aggiornamenti
