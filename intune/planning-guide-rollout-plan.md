...
description: Questo articolo consente di decidere i gruppi di cui eseguire l'implementazione in Intune e gli intervalli di tempo per tali distribuzioni.
keywords: 
author: andredm7
ms.author: andredm
manager: angrobe
...
## Gruppi di destinazione e intervalli di tempo
...
## Associare i gruppi di distribuzione agli approcci di registrazione
