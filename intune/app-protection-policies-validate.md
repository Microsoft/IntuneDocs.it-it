...
- Se l'utente non ha la licenza per la protezione delle app, assegnargli una [licenza di Intune](licenses.md).
- Se l'utente non ha una [licenza](licenses.md) per Office 365, ottenerne una per l'utente.
