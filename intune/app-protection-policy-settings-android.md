...
> [!NOTE]
> Per altre informazioni su come funzionano in Android più impostazioni di protezione app di Intune configurate nella sezione Accesso per lo stesso set di app e di utenti, vedere le [domande frequenti su Intune MAM](mam-faq.md).
