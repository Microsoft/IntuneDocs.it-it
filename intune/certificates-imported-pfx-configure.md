...
- **Connettore di certificati PFX per Microsoft Intune**:  
  ...
  Per altre informazioni su tutti gli endpoint di rete a cui accede il connettore, vedere [Requisiti di configurazione di rete di Intune e larghezza di banda](network-bandwidth-use.md).
