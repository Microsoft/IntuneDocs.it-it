...
- **Registrazione di Assistente configurazione**: esegue il ripristino delle impostazioni predefinite del dispositivo e lo prepara per la registrazione durante Assistente configurazione.
...
5. Nel pannello **Profili di registrazione di Apple Configurator** selezionare **Crea**.
...
7. Specificare **Affinità utente**:
   - **Registra con affinità utente**: il dispositivo deve essere associato a un utente con Assistente configurazione e può quindi accedere ai dati aziendali e alla posta elettronica. L'affinità utente è richiesta per i dispositivi gestiti che appartengono a utenti e che devono usare il portale aziendale per servizi come l'installazione di app.
...
4. Nel pannello **Assegna profilo** selezionare il profilo da assegnare in **Nuovo profilo** e quindi selezionare **Assegna**.
...
3. Nel pannello del profilo scegliere **Dispositivi assegnati** e quindi scegliere **Assegna**.
...
1. Nel portale di Azure in Intune scegliere **Registrazione del dispositivo** > Registrazione Apple** > **Profili AC** e quindi scegliere il profilo da esportare.
...
1. Accedere al portale di Azure.
2. Scegliere **Altri servizi** > **Monitoraggio e gestione** > **Intune**.
3. Nel pannello **Esporta il profilo** scaricare il profilo di registrazione in [Apple Configurator](https://itunes.apple.com/us/app/apple-configurator-2/id1037126344?mt=12) per inviarlo direttamente come profilo di gestione ai dispositivi iOS.
...
5. Usare la procedura seguente per installare il profilo nel dispositivo iOS. Il dispositivo deve aver già completato l'Assistente configurazione ed essere pronto per l'uso. Se la registrazione comporta distribuzioni dell'app, il dispositivo deve avere un ID Apple configurato perché le distribuzioni di app richiedono l'accesso all'App Store con un ID Apple.
...
6. Nel dispositivo iOS aprire la finestra **Impostazioni** e passare a **Generale**  >  **Gestione dei dispositivi**  >  **Profilo di gestione**. Verificare che l'installazione del profilo è inclusa nell'elenco e controllare le restrizioni dei criteri iOS e le app installate. La visualizzazione delle restrizioni dei criteri e delle app nel dispositivo può impiegare fino a 10 minuti.
