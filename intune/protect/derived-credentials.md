...
Esaminare il [flusso di lavoro degli utenti per Entrust Datacard](https://docs.microsoft.com/intune-user-help/enroll-ios-device-entrust-datacard). I requisiti principali per questo flusso di lavoro includono:
