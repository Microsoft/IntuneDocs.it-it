...
[Creare e distribuire criteri di protezione delle app Windows Information Protection (WIP) con Intune](https://docs.microsoft.comwindows-information-protection-policy-create.md)
