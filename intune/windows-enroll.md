...
- Abilitare la registrazione automatica (richiede Azure AD Premium)
- Registrazione CNAME
- Abilitare la registrazione in blocco (richiede Azure AD Premium e Progettazione configurazione di Windows)
