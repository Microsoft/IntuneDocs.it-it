...
>
> Per altre informazioni, vedere [Modifica prevista per Intune: fine del supporto per Windows 7](https://docs.microsoft.com/intune/fundamentals/whats-new#windows-7-ends-extended-support-).
>
