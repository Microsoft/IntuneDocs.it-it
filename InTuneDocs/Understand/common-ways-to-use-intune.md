...
## <a name="securing-your-onpremises-email-and-data-so-it-can-be-safely-accessed-by-mobile-devices"></a>Protezione di dati e messaggi di posta elettronica a livello locale in modo da consentire l'accesso sicuro dai dispositivi mobili
...
## <a name="securing-your-office-365-email-and-data-so-it-can-be-safely-accessed-by-mobile-devices"></a>Protezione di dati e messaggi di posta elettronica di Office 365 in modo da consentire l'accesso sicuro dai dispositivi mobili
...
## <a name="offer-a-bring-your-own-device-byod-program-to-all-employees"></a>Offrire un programma BYOD (Bring Your Own Device) a tutti i dipendenti
...
## <a name="issue-corporateowned-phones-to-your-information-workers"></a>Rilasciare telefoni di proprietà dell'azienda agli information worker
...
## <a name="issue-limiteduse-shared-tablets-to-your-task-workers"></a>Rilasciare tablet condivisi con limitazioni d'uso ai task worker
