...
## <a name="set-up-telemetry-for-your-app"></a>Impostazione della telemetria per l'app
...
## <a name="test-your-mamenabled-app-with-microsoft-intune"></a>Testare l'app abilitata per MAM con Microsoft Intune
