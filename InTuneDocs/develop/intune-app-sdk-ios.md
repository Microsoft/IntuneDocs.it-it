...
# <a name="microsoft-intune-app-sdk-for-ios-developer-guide"></a>Guida a Microsoft Intune App SDK per sviluppatori iOS
...
Microsoft Intune App SDK per iOS consente di integrare i criteri di protezione delle app di Intune nell'app iOS. Un'applicazione abilitata per la gestione delle applicazioni mobili si integra con Intune App SDK e consente agli amministratori IT di distribuire criteri all'app mobile quando l'app è attivamente gestita da Gestione di applicazioni mobili (MAM) di Intune.


## <a name="prerequisites"></a>Prerequisiti

* È necessario disporre di un computer Mac con OS X 10.8.5 o versioni successive e con il set di strumenti XCode versione 5 o successive.
...
## <a name="building-the-sdk-into-your-mobile-app"></a>Creazione dell'SDK nell'app mobile
...
ADAL richiede in genere che le app eseguano la registrazione con [Azure Active Directory] e ottengano un ID univoco, noto come ClientID, e altri identificatori per garantire la sicurezza dei token concessi all'app. Intune App SDK usa i valori di registrazione predefiniti per contattare Azure Active Directory.  
...
**Com'è possibile condividere la cache ADAL con altre app registrate con lo stesso profilo di provisioning?**
...
## <a name="register-your-app-with-intune-mam-service"></a>Registrare l'app con il servizio MAM di Intune
...
### <a name="de-register-accounts"></a>Annullare la registrazione degli account
...
## <a name="enrolling-without-prior-sign-in"></a>Registrazione senza accesso preventivo
...
## <a name="implementing-save-as-controls"></a>Implementazione dei controlli di salvataggio
...
## <a name="configure-intune-app-sdk-settings"></a>Configurare le impostazioni di Intune App SDK
...
## <a name="recommended-ios-best-practices"></a>Procedure consigliate per iOS
...
Sì, l'amministratore IT può inviare un comando di cancellazione selettiva all'applicazione, che comporterà l'annullamento della registrazione dell'utente e la cancellazione dei dati dell'utente.  L'SDK gestisce questo scenario automaticamente e invia una notifica tramite un metodo delegato di annullamento della registrazione.

## <a name="submitting-your-app-to-the-app-store"></a>Invio dell'app all'App Store
