...
La tabella seguente elenca gli errori che potrebbero verificarsi durante la registrazione del dispositivo iOS in Intune. Condividere il collegamento con l'amministratore IT. 

|Messaggio di errore|Problema|Informazioni per l'amministratore IT|
|-----------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|DeviceCapReached|Sono già stati registrati troppi dispositivi mobili.|L'utente deve rimuovere dal Portale aziendale uno dei dispositivi mobili attualmente registrati prima di poterne registrare un altro.|
