---
title: "Creare i criteri di conformità di Skycure Mobile Threat Defense| Microsoft Docs"
...
-   [Configurare l'integrazione di Skycure con Intune](https://docs.microsoft.com/en-us/intune/deploy-use/setup-the-skycure-integration-with-Intune)

-   [Abilitare la connessione a Skycure in Intune](https://docs.microsoft.com/intune/deploy-use/enable-skycure-mobile-threat-defense-in-intune)
...
-   Creare criteri di accesso condizionale per:
    ...
    -   [Exchange locale](https://docs.microsoft.com/intune/deploy-use/restrict-access-to-exchange-onpremises-with-microsoft-intune)
