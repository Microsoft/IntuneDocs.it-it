...
Ci sono due categorie di impostazioni dei criteri: impostazioni di rilocazione dei dati e impostazioni di accesso. In questo argomento il termine _**app gestite da criteri**_ indica le app configurate con criteri di protezione delle app.
