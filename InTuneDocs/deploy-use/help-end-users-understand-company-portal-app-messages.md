---
title: Messaggi dell&quot;app Portale aziendale visualizzati dagli utenti in Android | Microsoft Docs
...
Suggerire agli utenti di consultare l'articolo [Registrare il dispositivo Android in Intune](/Intune/EndUser/enroll-your-device-in-intune-android) per ottenere altre informazioni.
...
### <a name="how-to-explain-this-to-your-users"></a>Come spiegare questo agli utenti
Suggerire agli utenti di consultare l'articolo [Inviare i log all'amministratore IT tramite posta elettronica](/Intune/EndUser/send-logs-to-your-it-admin-by-email-android) e anche l'articolo [Send logs to your IT admin by cable](/Intune/EndUser/send-logs-to-your-it-admin-by-cable-android) (Inviare i log all'amministratore IT tramite cavo), se si vuole che confrontino i due metodi.
