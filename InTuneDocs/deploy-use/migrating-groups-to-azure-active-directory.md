...
## <a name="the-new-admin-experience-for-groups"></a>Nuova esperienza di amministrazione per i gruppi
...
## <a name="migration-details"></a>Dettagli sulla migrazione
Di seguito sono presentati i dettagli sulla modalità in cui verrà eseguita la migrazione dei gruppi ad Azure AD.

### <a name="migration-of-existing-groups"></a>Migrazione dei gruppi esistenti
...
### <a name="changes-in-hierarchical-views"></a>Modifiche nelle visualizzazioni gerarchiche
...
### <a name="attribute-conversion-during-migration"></a>Conversione dell'attributo durante la migrazione
...
## <a name="migration-of-policies"></a>Migrazione dei criteri
