...
-   È possibile attivare l'invio di un messaggio di posta elettronica a destinatari selezionati quando viene emesso un avviso di errore della distribuzione del software client configurando una regola di notifica nell'area di lavoro **Amministrazione** . Per altre informazioni, vedere [Ricevere notifiche tramite gli avvisi di Microsoft Intune](/intune/deploy-use/get-notified-by-microsoft-intune-alerts)..
...
3.  Fare clic su **Tutti gli avvisi** per visualizzare le seguenti informazioni nella pagina **Avvisi** . Gli avvisi critici vengono visualizzati per primi:
...
**Risoluzione:** 
Verificare che i criteri di aggiornamento software consentano di installare gli aggiornamenti critici, come descritto in [Mantenere i PC Windows aggiornati con gli aggiornamenti software in Microsoft Intune](/intune/deploy-use/keep-windows-pcs-up-to-date-with-software-updates-in-microsoft-intune) 
...
1.  Ritirare il computer come descritto in [Ritirare dispositivi e dati dalla gestione di Microsoft Intune](/intune/deploy-use/retire-devices-from-microsoft-intune-management).
...
|**0x80240438**, **0x80CF0438**, **0x80CF401B**|Impossibile connettersi al servizio Intune. Verificare le impostazioni proxy del client.|Verificare che la configurazione del proxy nel computer client sia supportata da Intune e che il computer client disponga di accesso a Internet. Per altre informazioni sulle configurazioni proxy supportate, vedere [Proteggere i PC Windows con Endpoint Protection per Microsoft Intune](/intune/deploy-use/help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune)..|
...
|**0x80070032**|Uno o più prerequisiti per l'installazione del software client non sono stati individuati nel computer client.|Assicurarsi che tutti gli aggiornamenti necessari siano installati nel computer client, quindi riprovare a installare il software client. Per altre informazioni sui prerequisiti per l'installazione del software client, vedere [Requisiti dell'infrastruttura di rete per Microsoft Intune](/intune/get-started/network-infrastructure-requirements-for-microsoft-intune)..|
|**0x80043008**|Impossibile avviare il servizio Aggiornamenti di Microsoft Online Management.|Contattare il supporto tecnico, come descritto in [Come ottenere supporto per Microsoft Intune](how-to-get-support-for-microsoft-intune.md)..|
|**0x80043009**|Il computer client è già registrato al servizio.|È necessario ritirare il computer client prima di potersi registrare nuovamente al servizio. Per le istruzioni, vedere [Ritirare dispositivi e dati dalla gestione di Microsoft Intune](/intune/deploy-use/retire-devices-from-microsoft-intune-management).|
|**0x8004300B**|Impossibile eseguire l'installazione del software client perché la versione di Windows in esecuzione nel client non è supportata.|Intune non supporta la versione di Windows in esecuzione nel computer client. Per un elenco dei sistemi operativi supportati, vedere [Requisiti dell'infrastruttura di rete per Microsoft Intune](/intune/get-started/network-infrastructure-requirements-for-microsoft-intune).|
