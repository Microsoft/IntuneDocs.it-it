...
3.  Nel [Portale di Office 365](http://go.microsoft.com/fwlink/p/?LinkId=698854).verificare che il nome utente e la password siano quelli corretti per accedere a Intune e che siano nel formato: **joe@dominio.com**..

### Se le informazioni di Contatta l'IT non sono presenti nel Portale aziendale

1.  Nella console di amministrazione di Intune fare clic su **Amministratore** &gt; **Portale aziendale**..
...
### Se facendo clic su un collegamento a un'app per iOS viene visualizzata una posizione precedente nell'iTunes App Store
...
Immettere l'autore mancante e verrà visualizzato l'errore **Autore inesistente**. 
