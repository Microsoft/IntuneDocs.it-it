...
|---------------|------------------------|
|**Configurazione personalizzata (Android 4 e versioni successive, Samsung KNOX Standard 4.0 e versioni successive)**|Distribuire le impostazioni URI OMA (Open Mobile Alliance Uniform Resource Identifier), ad esempio le impostazioni Wi-Fi che possono essere usate per controllare le funzionalità del dispositivo. Questo criterio è utile quando l'impostazione necessaria non è disponibile nei criteri di configurazione.<br /><br />Per informazioni dettagliate, vedere [Impostazioni dei criteri di Android e Samsung KNOX in Microsoft Intune](android-policy-settings-in-microsoft-intune.md).|
...
|**Profilo certificato SCEP (iOS 7.1 e versioni successive)**|Configurare un certificato Simple Certificate Enrollment Protocol (SCEP) che può essere usato con un certificato attendibile per i dispositivi mobili per autenticare i dispositivi mobili e consentire loro l'accesso a risorse di rete, quali quelle configurate dai profili Wi-Fi e VPN.<br /><br />Per informazioni dettagliate, vedere [Proteggere l'accesso alle risorse con i profili certificato in Microsoft Intune](secure-resource-access-with-certificate-profiles.md).|
|**Profilo certificato attendibile (iOS 7.1 e versioni successive)**|Configurare un certificato attendibile per i dispositivi mobili che può essere usato per autenticare i dispositivi mobili e consentire loro l'accesso a risorse di rete, quali quelle configurate da profili VPN e Wi-Fi.<br /><br />Per informazioni dettagliate, vedere [Proteggere l'accesso alle risorse con i profili certificato in Microsoft Intune](secure-resource-access-with-certificate-profiles.md).|
|**Profilo VPN (iOS 7.1 e versioni successive)**|Configurare e distribuire le impostazioni che permettono agli utenti di accedere in modo sicuro alla rete aziendale dai propri dispositivi mobili. Distribuendo queste impostazioni, si semplifica la connessione degli utenti finali al proprio lavoro.<br /><br />Per informazioni dettagliate, vedere [Connessioni VPN in Microsoft Intune](vpn-connections-in-microsoft-intune.md).|
...
|**Criterio di protezione del dispositivo mobile**|<ul><li>Configura le impostazioni per i dispositivi mobili (tutte le piattaforme), ad esempio:<br /><br /><ul><li>Sicurezza</li><li>Crittografia</li><li>Sistema</li><li>Posta elettronica</li><li>Applicazioni</li></ul></li></ul>
> [!IMPORTANT]
