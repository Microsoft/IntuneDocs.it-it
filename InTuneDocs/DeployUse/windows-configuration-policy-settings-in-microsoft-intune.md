...
|Nome impostazione|Dettagli|
|----------------|-----|
|**Richiedi crittografia sui dispositivi mobili**<sup>1</sup>|Richiede la crittografia dei file nel dispositivo.|
...
|Nome impostazione|Dettagli|
|----------------|----|
|**Consenti dati in roaming**|Abilita il roaming dati quando il dispositivo si trova in una rete cellulare.|
