...
## Usare i criteri di Intune per gestire Windows Firewall
...
## Specificare le impostazioni dei criteri per Windows Firewall
...
### Configurare le eccezioni predefinite
