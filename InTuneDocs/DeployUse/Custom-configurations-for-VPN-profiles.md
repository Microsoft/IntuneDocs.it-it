...
È possibile usare configurazioni personalizzate per creare profili VPN in Intune. Per creare una configurazione personalizzata:
   ...
   ![Finestra di dialogo Configurazione personalizzata per il profilo VPN](intune/media/Intune_Add_VPN_URI.png)
...
2.  Nella finestra di dialogo **Gestisci distribuzione** :
    ...
    -   **Per distribuire il criterio**, selezionare uno o più gruppi in cui si vuole distribuirlo, quindi fare clic su **Aggiungi** &gt; **OK**.
...
Per eventuali domande su come usare queste impostazioni o per altre informazioni sulla loro funzione, i clienti possono vedere la documentazione CSP (Configuration Service Provider):
