...
# Come distribuire app a dispositivi Android for Work con Intune
...
## Sincronizzare un'app da Google Play for Work
...
3. Nella pagina dell'app selezionata scegliere **Approva**. In questo esempio è stata scelta l'app Microsoft Excel.<br>
  ![Approvare l'esempio di app](/intune/deploy-use/media/approve.png)
4. Viene visualizzata una finestra per l'app in cui viene richiesto di concedere le autorizzazioni che consentono all'app di eseguire diverse operazioni. È necessario scegliere **Approva** per continuare.<br>
  ![Approvare l'esempio di autorizzazioni per l'app](/intune/deploy-use/media/approve-app-permissions.png)
...
## Pubblicare e sincronizzare un'app line-of-business da Google Play for Work 

1. Passare a Google Play Developer Console [play.google.com/apps/publish](play.google.com/apps/publish).
...
## Distribuire un'app Android for Work
