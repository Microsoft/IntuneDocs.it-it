...
2.  Dopo l'accesso verrà visualizzata la pagina del **Dashboard**. La pagina **Dashboard** può essere personalizzata.
...
4.  Scegliere **Intune** > **Gestione di applicazioni mobili di Intune** > **Impostazioni**.
    ...
    > [!TIP]
    > Fare clic sull'icona della puntina nel pannello **Gestione di applicazioni mobili di Intune** per aggiungerlo alla pagina **iniziale** .
