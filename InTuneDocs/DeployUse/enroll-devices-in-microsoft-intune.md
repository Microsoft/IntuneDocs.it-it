...
| **Metodo** |  **[Cancellazione](#Wipe)** | **[Affinità](#Affinity)**   |   **[Bloccato](#Lock)** |
|:---:|:---:|:---:|:---:|
|**[BYOD](#BYOD)** | No|    Sì |   No |
|**[DEM](#DEM)**|   No |No |No  |
|**[DEP](#DEP)**|   sì |   Opt |   Opt|
...
[Ritirare i dispositivi](retire-devices-from-microsoft-intune-management.md) ([Tornare alla tabella](#overview-of-device-enrollment-methods))
...
([Tornare alla tabella](#overview-of-device-enrollment-methods))
