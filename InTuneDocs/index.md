...
ms.topic: hub-page
title: Documentazione di Microsoft Intune |Microsoft Docs
description: Informazioni su come usare Microsoft Intune (FIXME)
...
<div class="container">
    <h1>Documentazione di Microsoft Intune</h1>
    <ul class="pivots">
        <li>
            <a href="#manage">Gestione</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Articoli in primo piano</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Articoli più consultati</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Articoli consigliati</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Nuovi articoli</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Intune nell'anteprima del portale di Azure</a></h3>
                                            <p>Informazioni sulle modifiche disponibili nel nuovo portale di Azure in seguito alla migrazione di Intune. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">Pianificazione e progettazione della distribuzione</a></h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">Come informare gli utenti finali su Microsoft Intune</a></h3>
                                            <p>Informazioni su come richiedere agli utenti finali di adottare l'accesso protetto fornito da Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Uso di Intune in Microsoft Graph</a></h3>
                                            <p>Usare le API di Microsoft Graph per configurare i criteri e i controlli di Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">Più di 150 licenze? Sfruttare i vantaggi di FastTrack</a></h3>
                                            <p>Possibilità di collaborare con esperti Microsoft per accedere ai servizi, abilitarli, promuoverne l'uso e risolvere problemi.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">Domande frequenti sulla gestione di applicazioni mobili e sulla protezione delle app</a></h3>
                                            <p>Risposte ad alcune domande frequenti sulla gestione di app mobili e sulla protezione delle app di Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/understand-explore/introduction-to-microsoft-intune">tutta la documentazione di Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Introduzione</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Informazioni sulle funzionalità offerte da Intune per gestire dispositivi, app e dati per dispositivi mobili e PC Windows.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Gestione di dispositivi mobili in Microsoft Intune</h3>
                                            <p>Valutare come funziona la gestione di dispositivi mobili in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/understand-explore/introduction-to-microsoft-intune">tutta la documentazione introduttiva</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Pianificare la distribuzione</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Determinare scopi, obiettivi e sfide</h3>
                                            <p>Definire gli scopi, gli obiettivi e i problemi che è necessario gestire durante la distribuzione.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Identificare gli scenari per i casi d'uso</h3>
                                            <p>Esaminare alcuni casi di esempio mentre si identificano gli scenari per i casi d'uso di distribuzione. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Elaborare un piano di implementazione</h3>
                                            <p>Determinare i gruppi organizzativi assegnati per l'implementazione di Intune e i tempi di distribuzione per ogni gruppo.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/plan-design/introduction">tutta la documentazione relativa alla pianificazione della distribuzione</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Procedure</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Creare criteri di accesso condizionale</h3>
                                            <p>Informazioni su come configurare l'accesso condizionale per Exchange locale in base alla conformità del dispositivo.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Impostare l'autorità di gestione di dispositivi mobili</h3>
                                            <p>Informazioni sulle opzioni disponibili quando si imposta l'autorità di gestione di dispositivi mobili.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configurare i profili di dispositivo</h3>
                                            <p>Informazioni su come creare profili di configurazione dei dispositivi in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configurare le restrizioni dei dispositivi</h3>
                                            <p>Informazioni su come configurare le impostazioni relative alle restrizioni dei dispositivi in Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Gestire le app</h3>
                                            <p>Informazioni su come aggiungere, assegnare e monitorare le app.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Creare e assegnare criteri di protezione delle app</h3>
                                            <p>Informazioni su come creare e assegnare criteri di protezione delle app.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">tutta la documentazione relativa alle procedure</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Monitorare e risolvere i problemi</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Problemi noti</h3>
                                            <p>Informazioni sui problemi noti dell'anteprima di Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Risoluzione dei problemi di distribuzione delle app</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Risoluzione dei problemi di registrazione dei dispositivi</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Risoluzione dei problemi dei profili di dispositivo</h3>
                                            <p>Risolvere i problemi riscontrati durante la creazione di profili per i dispositivi.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Risoluzione dei problemi dei profili di posta elettronica</h3>
                                            <p>Risolvere i problemi riscontrati durante la creazione di profili per la posta elettronica.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vedere <a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">tutta la documentazione per la risoluzione dei problemi</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Panoramica di Intune App SDK</h3>
                                            <p>Informazioni sull'SDK che è possibile usare per abilitare l'app per i criteri di protezione delle app di Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Utilizzo di Intune in Microsoft Graph</h3>
                                            <p>Usare le API di Microsoft Graph per configurare i criteri e i controlli di Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Preparare le app line-of-business per MAM</h3>
                                            <p>Consentire alle app di usare i criteri di gestione di applicazioni mobili (MAM, Mobile Application Management) tramite lo strumento di wrapping delle app di Intune o Intune App SDK.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Si vuole consultare l'intera documentazione? Vedere <a href="/intune/understand-explore/introduction-to-microsoft-intune">tutta la documentazione di Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Inviare commenti e suggerimenti su Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Seguire Microsoft Intune su Twitter</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Pubblicare domande e risposte sul forum</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Leggere il blog su Enterprise Mobility + Security</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Inviare commenti e suggerimenti sul servizio Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Inviare commenti e suggerimenti sulla documentazione di Intune</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
